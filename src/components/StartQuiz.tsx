...
function StartScreen({ onStart, scores }: StartScreenProps) {
  ...
  return (
    <div
      className={`flex rounded-lg shadow-md justify-center max-w-5xl w-full max-h-screen md:w-3/4 lg:w-full overflow-hidden ${
        isMobileOrTablet ? 'bg-custom-half-blackboard' : 'bg-custom-blackboard'
      }`}
    >
      <div className="flex flex-col mx-2 text-center w-11/12 md:w-90 lg:w-full lg:px-24 lg:py-28 overflow-auto">
        <div className="my-12 px-16">
          ...
          <button
            onClick={onStart}
            className="mt-8 my-2 md:my-4 p-12 font-semibold bg-transparent hover:bg-blue-500 text-blue-500  hover:text-white py-2  border border-white hover:border-transparent rounded"
          >
            Iniciar Quiz
          </button>
        </div>
        ...
        <div className="mb-2 px-16">
          <h2 className="text-xl text-white font-bold mb-2 pb-2 border-b-2 border-white">
            Mejores puntajes
          </h2>
          <div className="overflow-hidden text-white w-full max-h-64 mb-12 rounded-xl shadow-lg">
